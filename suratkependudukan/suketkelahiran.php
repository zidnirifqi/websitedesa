                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="#">Kependudukan</li><li class="active">Surat Keterangan Kelahiran</li>
                        </ol>
                    </div>
                </div>
            </div>
          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatortu" data-toggle="modal" data-target="#modalSurat" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Kelahiran</button>
                            ...
                            <div class="card-body card-block">
                                ...
                                <?php }}?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nama2" name="nama2" placeholder="Nama Anak"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tmp_lahir2" name="tmp_lahir2" placeholder="Tempat Lahir Anak"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl_lahir" class=" form-control-label">Tanggal Lahir</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tgl_lahir2" name="tgl_lahir2" placeholder="Tanggal Lahir Anak"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="rt2" name="rt2" placeholder="Rt. xxx/Rw. xxx" class="form-control"><small class="form-text text-muted">Contoh : Rt. 001/Rw. 002</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="dusun2" class=" form-control-label">Dusun</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="dusun2" name="dusun2" placeholder="Dusun" class="form-control"><small class="form-text text-muted">Contoh : Dusun Tegal Sari</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="anake" class=" form-control-label">Anak Ke</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="anake" name="anake" placeholder="Anak ke xxxx" class="form-control" required></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="rt" class=" form-control-label">Rt./Rw.</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="rt" name="rt"  placeholder="Rt. xxx/Rw. xxx" class="form-control"><small class="form-text text-muted">Contoh : Kp. Durian Runtuh Rt. 001/Rw. 002</small></div>
                                    </div>
                                    <div class="row form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_suketlahir WHERE kodejenis='JS017' ORDER BY id DESC ");
                            while ($r = mysqli_fetch_array($query)){
                         ?>
                                        <tr>
                                            <td><?php echo $r['id'];?></td>
                                            ...
                                            <td><?php echo $r['namaanak'];?></td>
                                            <td><a href="../cetak/c_suketlahir.php?kode=<?php echo $r['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a><a href="../edit/edit_suketlahir.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-edit"></i></a>
