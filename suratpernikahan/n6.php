                        ...
                        <?php 
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><a href="../cetak/c_n6.php?kode=<?php echo $r['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a><a href="../edit/edit_suketmati.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-edit"></i></a><a href="../hapus/h_suketmati.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                       <?php }?>
                                    </tbody>
                                </table>
