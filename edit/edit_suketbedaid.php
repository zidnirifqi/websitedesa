                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nama1" name="nama1" placeholder="Nama yang tertera di Identitas 1" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tmp_lahir1" name="tmp_lahir1" placeholder="Tempat Lahir yang tertera di Identitas 1" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl_lahir1" class=" form-control-label">Tanggal Lahir</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tgl_lahir1" name="tgl_lahir1" placeholder="Tanggal Lahir yang tertera di Identitas 1" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="rt1" name="rt1"  readonly="readonly" placeholder="Rt. xxx/Rw. xxx yang tertera di Identitas 1" class="form-control"><small class="form-text text-muted">Contoh : Rt. 001/Rw. 002</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="dusun1" class=" form-control-label">Dusun</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="dusun1" name="dusun1"  readonly="readonly" placeholder="Dusun yang tertera di Identitas 1" class="form-control"><small class="form-text text-muted">Contoh : Dusun Tegal Sari</small></div>
                                    </div>
                                <hr>
                                <div class="row form-group">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nama2" name="nama2" placeholder="Nama yang tertera di Identitas 2" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tmp_lahir2" name="tmp_lahir2" placeholder="Tempat Lahir  yang tertera di Identitas 2" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl_lahir2" class=" form-control-label">Tanggal Lahir</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tgl_lahir2" name="tgl_lahir2" placeholder="Tanggal Lahir yang tertera di Identitas 2" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="rt2" name="rt2"  readonly="readonly" placeholder="Rt. xxx/Rw. xxx yang tertera di Identitas 2" class="form-control"><small class="form-text text-muted">Contoh : Rt. 001/Rw. 002</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="dusun2" class=" form-control-label">Dusun</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="dusun2" name="dusun2"  readonly="readonly" placeholder="Dusun yang tertera di Identitas 2" class="form-control"><small class="form-text text-muted">Contoh : Dusun Tegal Sari</small></div>
                                    </div>
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_suketbdeaid.php?kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratumum/suketbedaid.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN PERBEDAAN IDENTITAS</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT * FROM t_suketbedaid  where kode='$_GET[kode]' ");
            $no=1;
            ...
            ?>  
                    <form action="../update/u_suketbedaid.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                        <div class="col col-md-3"><label for="id1" class=" form-control-label"><b>IDENTITAS 1</b></label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="id1" name="id1" value="<?php echo $row ['id1']; ?>"  class="form-control "></div>
                                </div>
                                <hr>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nik1" class=" form-control-label">NIK</label></div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="jk1" id="jk1" class="form-control">
                                                <option value="<?php echo $row ['jk1']; ?>" selected="selected"><?php echo $row ['jk1']; ?></option>
                                                <option value="Laki-laki">Laki-laki</option>
                                                <option value="Perempuan">Perempuan</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="agama1" id="agama1" class="form-control">
                                                <option value="<?php echo $row ['agama1']; ?>" selected="selected"><?php echo $row ['agama1']; ?></option>
                                                <option value="Islam">Islam</option>
                                                <option value="Katholik">Katholik</option>
                                                <option value="Protestan">Protestan</option>
                                                <option value="Hindu">Hindu</option>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="alamat1" name="alamat1" value="<?php echo $row ['alamat1']; ?>" class="form-control"></div>
                                    </div>
                                <hr>
                                <div class="row form-group">
                                        <div class="col col-md-3"><label for="id2" class=" form-control-label"><b>IDENTITAS 2</b></label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="id2" name="id2" value="<?php echo $row ['id2']; ?>"  class="form-control "></div>
                                </div>
                                <hr>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nik2" class=" form-control-label">NIK</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nik2" name="nik2" onkeyup="isinik2()" class="form-control" maxlength="16"  value="<?php echo $row ['nik2']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama2" class=" form-control-label">Nama</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nama2" name="nama2" value="<?php echo $row ['nama2']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jk2" class=" form-control-label">Jenis Kelamin</label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="jk2" id="jk2" class="form-control">
                                                <option value="<?php echo $row ['jk2']; ?>" selected="selected"><?php echo $row ['jk2']; ?></option>
                                                <option value="Laki-laki">Laki-laki</option>
                                                <option value="Perempuan">Perempuan</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tmp_lahir2" class=" form-control-label">Tempat Lahir</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tmp_lahir2" name="tmp_lahir2" value="<?php echo $row ['tmp_lahir2']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl_lahir2" class=" form-control-label">Tanggal Lahir</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tgl_lahir2" name="tgl_lahir2" value="<?php echo $row ['tgl_lahir2']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="agama2" class=" form-control-label">Agama</label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="agama2" id="agama2" class="form-control">
                                                <option value="<?php echo $row ['agama2']; ?>" selected="selected"><?php echo $row ['agama2']; ?></option>
                                                <option value="Islam">Islam</option>
                                                <option value="Katholik">Katholik</option>
                                                <option value="Protestan">Protestan</option>
                                                <option value="Hindu">Hindu</option>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="alamat2" name="alamat2"  value="<?php echo $row ['alamat2']; ?>" class="form-control"></div>
                                    </div>
