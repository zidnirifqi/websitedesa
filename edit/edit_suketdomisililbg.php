...
<!-- END MODAL SUKET UMUM -->
 ...
 <?php
            $data=mysqli_query($con, "SELECT * FROM t_suketdomisililbg  where kode='$_GET[kode]' ");
            $no=1;
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratumum/suketdomisililbg.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN DOMISILI LEMBAGA</h5>
                    ...
                    <form action="../update/u_suketdomisililbg.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="namalbg" class=" form-control-label">Nama Lemabaga</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="namalbg" name="namalbg" value="<?php echo $row ['nama_lbg']; ?>"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="bidanglbg" class=" form-control-label">Bidang</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="bidanglbg" name="bidanglbg" value="<?php echo $row ['bidang_lbg']; ?>"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="namaketua" class=" form-control-label">Nama Pimpinan/Ketua</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="namaketua" name="namaketua" value="<?php echo $row ['nama_ketua']; ?>"   class="form-control"></div>
                                    </div>

                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="almt" class=" form-control-label">Alamat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt"  value="<?php echo $row ['alamat']; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Kp. Durian Runtuh Rt. 001/Rw. 002 Desa Pamulihan Kec. Way Sulan Kab. Lampung Selatan Prov. Lampung</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="sejak" class=" form-control-label">Berdiri Sejak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="sejak" name="sejak"  value="<?php echo $row ['sejak']; ?>"  class="form-control"><small class="form-text text-muted">Contoh : 12 Januari 2015</small></div>
                                    </div>
