                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Umum</li> <li class="active">Surat Keterangan Usaha</li>
                        </ol>
                    </div>
                </div>
            </div>
          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Usaha</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT KETERANGAN USAHA</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_suketusaha.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_suketusaha WHERE kodejenis='JS001' ORDER BY id ASC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_suketusaha.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratumum/suketusaha.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN USAHA</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_suketusaha.*, t_penduduk.* FROM t_suketusaha, t_penduduk  where t_suketusaha.kode='$_GET[kode]' AND t_suketusaha.nik=t_penduduk.nik ");
            $no=1;
            ...
            ?>  
                    <form action="../update/u_suketusaha.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jnusaha" class=" form-control-label">Jenis / Bidang Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jnusaha" name="jnusaha" value="<?php echo $row ['jnusaha']; ?>"   class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="mulaiusaha" class=" form-control-label">Berjalan Sejak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="mulaiusaha" name="mulaiusaha" value="<?php echo $row ['mulaiusaha']; ?>"   class="form-control"></div>
                                    </div>
                                                                        <div class="row form-group">
                                        <div class="col col-md-3"><label for="lokusaha" class=" form-control-label">Alamat / Lokasi Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="lokusaha" name="lokusaha" value="<?php echo $row ['lokusaha']; ?>"   class="form-control"></div>
                                    </div>
