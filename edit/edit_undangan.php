...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../tatausaha/undangan.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT UNDANGAN</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT * FROM t_undangan  where kode='$_GET[kode]' ");
            $no=1;
            ...
            ?>  
                    <form action="../update/u_undangan.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                           ...
                           <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="keg" class=" form-control-label">Kegiatan / Acara</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="keg" name="keg" value="<?php echo $row ['keg']; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Musyawarah Penyusunan RKPDesa Tahun 2023</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="hari" class=" form-control-label">Hari</label></div>
                                        <div class="col-12 col-md-9">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl" class=" form-control-label">Tanggal</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tgl" name="tgl" value="<?php echo $row ['tgl']; ?>"  class="form-control"><small class="form-text text-muted">Contoh : 12 April 2023</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="wkt" class=" form-control-label">Waktu</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="wkt" name="wkt" value="<?php echo $row ['wkt']; ?>"   class="form-control"><small class="form-text text-muted">Contoh : 08.30 WIB</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tmp" class=" form-control-label">Tempat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tmp" name="tmp"  value="<?php echo $row ['tmp']; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Aula Desa Dagelan</small></div>
                                    </div>
