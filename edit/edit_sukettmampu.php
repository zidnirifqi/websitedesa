          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Tidak Mampu</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT KETERANGAN TIDAK MAMPU</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_sukettmampu.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_sukettmampu.*, t_penduduk.* FROM t_sukettmampu, t_penduduk WHERE t_sukettmampu.kodejenis='JS005' AND t_sukettmampu.nik=t_penduduk.nik ORDER BY t_sukettmampu.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_sukettmampu.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratumum/sukettmampu.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN TIDAK MAMPU</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_sukettmampu.*, t_penduduk.* FROM t_sukettmampu, t_penduduk  where t_sukettmampu.kode='$_GET[kode]' AND t_sukettmampu.nik=t_penduduk.nik ");
            $no=1;
                    ...
                    <form action="../update/u_sukettmampu.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="untuk" name="untuk"  required value="<?php echo $row ['untuk']; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Beasiswa</small></div>
                                    </div>
