                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="#">Tata Usaha</a></li><li class="active">Surat Jawaban</li>
                        </ol>
                    </div>
                </div>
            </div>
          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Jawaban</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT JAWABAN</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_jawaban.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
...
<hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="perihal" name="perihal" placeholder="Isi dengan perihal yang akan disampaikan / dikirim" class="form-control"><small class="form-text text-muted">Contoh : Laporan Pencapaian Pembayaran Pajak Bumi dan Bangunan Tahun 2023</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="lampiran" class=" form-control-label">Lampiran</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="lampiran" name="lampiran" placeholder="Isi dengan jumlah lampiran"  class="form-control"><small class="form-text text-muted">Contoh : 1 Lembar</small></div>
                                    </div>
                                    <div class="row form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_jawaban WHERE kodejenis='JS030' ORDER BY id ASC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_jawaban.php?kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../tatausaha/jawaban.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT JAWABAN</h5>
 
                            </div>
        <div class="input-group ">
            <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT * FROM t_jawaban  where kode='$_GET[kode]' ");
            $no=1;
 ...
 <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="perihal" class=" form-control-label">Perihal</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="perihal" name="perihal" value="<?php echo $row ['perihal']; ?>" class="form-control"><small class="form-text text-muted">Contoh : Laporan Pencapaian Pembayaran Pajak Bumi dan Bangunan Tahun 2023</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="lampiran" class=" form-control-label">Lampiran</label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jawaban" class=" form-control-label">Detail Jawaban</label></div>
                                        <div class="col-12 col-md-9"><textarea rows="5" id="jawaban" name="jawaban" class="form-control"><?php echo $row ['jawaban']; ?></textarea><small class="form-text text-muted">Contoh : Pencapaian Pembayaran Pajak Bumi dan Bangunan Desa Dagelan sudah mencapai 75% sebagaimana data terlampir.</small></div>
                                    </div>
                                    <hr>
                                    <h6 class="label">DASAR / LANDASAN / SURAT YANG PERLU DIJAWAB :</h6>
                                    <hr> 
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="dasar" class=" form-control-label">Dasar Surat</label></div>
                                        <div class="col-12 col-md-9"><textarea rows="4" id="dasar" name="dasar" class="form-control"><?php echo $row ['dasar']; ?></textarea><small class="form-text text-muted">Contoh : Surat Camat Way Sulan Nomor : 123, Tanggal 12 Mei 2023, Perihal Laporan Pencapaian Pembayaran Pajak Bumi dan Bangunan Tahun 2023</small></div>
                                    </div>
                                    <hr>
                                    <h6 class="label">NAMA / LEMBAGA YANG DITUJU :</h6>
                                    <hr>
