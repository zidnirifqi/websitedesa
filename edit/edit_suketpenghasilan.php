          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Penghasilan</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT KETERANGAN PENGHASILAN</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_suketpenghasilan.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="jnusaha" name="jnusaha" placeholder="Isi dengan Jenis atau Bidang Usaha yang dijalani" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="mulaiusaha" class=" form-control-label">Berjalan Sejak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="mulaiusaha" name="mulaiusaha" placeholder="Isi dengan tanggal, bulan atau tahun mulai memiliki usaha tsb." readonly="readonly" class="form-control"></div>
                                    </div>
                                                                        <div class="row form-group">
                                        <div class="col col-md-3"><label for="lokusaha" class=" form-control-label">Alamat / Lokasi Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="lokusaha" name="lokusaha" placeholder="Isi dengan alamat atau lokasi tempat Usaha" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jmlhasil" class=" form-control-label">Penghasilan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="jmlhasil" id="jmlhasil" rows="3" placeholder="Isi dengan Jumlah Penghasilan per bulan" class="form-control"><small class="form-text text-muted">Contoh : Rp. 5.000.000,-</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="sumberhasil" class=" form-control-label">Sumber Penghasilan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="sumberhasil" id="sumberhasil" rows="3" placeholder="Isi dengan Sumber Penghasilan" class="form-control"><small class="form-text text-muted">Contoh : Dari Pekerjaan sebagai Karyawan di PT. xxxxxxx</small></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_suketpenghasilan.*, t_penduduk.* FROM t_suketpenghasilan, t_penduduk WHERE kodejenis='JS008' AND t_suketpenghasilan.nik=t_penduduk.nik ORDER BY t_suketpenghasilan.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_suketpenghasilan.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratumum/suketpenghasilan.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN PENGHASILAN</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_suketpenghasilan.*, t_penduduk.* FROM t_suketpenghasilan, t_penduduk  where kode='$_GET[kode]' AND t_suketpenghasilan.nik=t_penduduk.nik ");
            $no=1;
                    ...
                    <form action="../update/u_suketpenghasilan.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jmlhasil" class=" form-control-label">Penghasilan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="jmlhasil" id="jmlhasil" rows="3" value="<?php echo $row ['jmlhasil']; ?>"class="form-control"><small class="form-text text-muted">Contoh : Rp. 5.000.000,-</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="sumberhasil" class=" form-control-label">Sumber Penghasilan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="sumberhasil" id="sumberhasil" rows="3" value="<?php echo $row ['sumberhasil']; ?>" class="form-control"><small class="form-text text-muted">Contoh : Dari Pekerjaan sebagai Karyawan di PT. xxxxxxx</small></div>
                                    </div>
<hr>
                                    <div class="row form-group">
