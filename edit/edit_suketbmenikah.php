          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Belum Pernah Menikah</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT KETERANGAN BELUM PERNAH MENIKAH</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_suketbmenikah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_suketbnikah.*, t_penduduk.* FROM t_suketbnikah, t_penduduk WHERE t_suketbnikah.kodejenis='JS021' AND t_suketbnikah.nik=t_penduduk.nik ORDER BY t_suketbnikah.id DESC ");
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_suketbmenikah.php?kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratpernikahan/suketbelumnikah.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN BELUM PERNAH MENIKAH</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_suketbnikah.*, t_penduduk.* FROM t_suketbnikah, t_penduduk  where t_suketbnikah.kode='$_GET[kode]' AND t_suketbnikah.nik=t_penduduk.nik ");
            $no=1;
