          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Pengantar Pindah</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT PENGANTAR PINDAH</h5>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_sutarpindah.*, t_penduduk.* FROM t_sutarpindah, t_penduduk WHERE t_sutarpindah.kodejenis='JS016' AND t_sutarpindah.nik=t_penduduk.nik ORDER BY t_sutarpindah.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_sutarpindah.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratkependudukan/sutarpindah.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT PENGANTAR PINDAH</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_sutarpindah.*, t_penduduk.* FROM t_sutarpindah, t_penduduk where t_sutarpindah.kode='$_GET[kode]' AND t_sutarpindah.nik=t_penduduk.nik");
            $no=1;
            ...
            ?>  
                    <form action="../update/u_sutarpindah.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tujuan" class=" form-control-label">Tujuan Pindah</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tujuan" name="tujuan"  value="<?php echo $row ['tujuan']; ?>" class="form-control"><small class="form-text text-muted">Contoh : Desa Pamulihan Kec. Way Sulan Kab. Lampung Selatan</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jmlpindah" class=" form-control-label">Jumlah Keluarga yang Pindah</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jmlpindah" name="jmlpindah"  value="<?php echo $row ['jmlpindah']; ?>" class="form-control"></div>
                                    </div>
