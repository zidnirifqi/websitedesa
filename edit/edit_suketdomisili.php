          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Domisili</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT KETERANGAN DOMISILI</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_suketdomisili.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="sejak" name="sejak" placeholder="Isi dengan tanggal / tahun sejak tinggal" class="form-control"><small class="form-text text-muted">Contoh : 12 Januari 2015</small></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                             $query = mysqli_query ($con, "SELECT t_suketdomisili.*, t_penduduk.* FROM t_suketdomisili, t_penduduk WHERE t_suketdomisili.kodejenis='JS015' AND t_suketdomisili.nik=t_penduduk.nik ORDER BY t_suketdomisili.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_suketdomisili.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratkependudukan/suketdomisili.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN DOMISILI</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_suketdomisili.*, t_penduduk.* FROM t_suketdomisili, t_penduduk  where t_suketdomisili.kode='$_GET[kode]' AND t_suketdomisili.nik=t_penduduk.nik");
            $no=1;
            ...
            ?>  
                    <form action="../update/u_suketdomisili.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="sejak" class=" form-control-label">Tinggal Sejak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="sejak" name="sejak" value="<?php echo $row ['sejak']; ?>"   class="form-control"></div>
                                    </div>
