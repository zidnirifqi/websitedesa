                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="#">Tata Usaha</a></li><li class="active">Surat Pengantar</li>
                        </ol>
                    </div>
                </div>
            </div>
          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Pengantar</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT PENGANTAR</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_pengantar.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <input type="hidden" id="kodedesa" name="kodedesa" value="<?php echo $rdes['kodedesa'];?>" >
                                        <input type="hidden" id="kodekec" name="kodekec" value="<?php echo $rdes['kodekec']; ?>" >
...
<hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="banyak" name="banyak" placeholder="Isi dengan jumlah lampiran"  class="form-control"><small class="form-text text-muted">Contoh : 1 Bundel</small></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="dasar" name="dasar" placeholder="Isi dengan dasar surat terkait " class="form-control"><small class="form-text text-muted">Contoh : Surat Camat Way Sulan Nomor : 123, Tanggal 12 Mei 2023, Perihal Laporan Penduduk Bulan Mei 2023</small></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="lbg" name="lbg" placeholder="Isi dengan Nama / Lembaga yang dituju"  class="form-control"><small class="form-text text-muted">Contoh : Camat Way Sulan</small></div>
                                    </div>
                                    <div class="row form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM t_pengantar WHERE kodejenis='JS026' ORDER BY id ASC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['lbg'];?></td>
                                            <td>
                                                <a href="../cetak/c_pengantar.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="../edit/edit_pengantar.php?kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../tatausaha/pengantar.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT PENGANTAR</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT * FROM t_pengantar  where kode='$_GET[kode]' ");
            $no=1;
            ...
            ?>  
                    <form action="../update/u_pengantar.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                        <div class="col col-md-3"><label for="nosurat" class=" form-control-label">No. Surat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nosurat" name="nosurat" class="form-control" value="<?php echo $row ['no']; ?>" ><small class="form-text text-muted">Contoh : 001</small></div>
                                </div>
                                <hr>
                                    <h6 class="label">DETAIL PENGANTAR :</h6>
                                    <hr> 
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="objek" class=" form-control-label">Perihal</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="objek" name="objek"value="<?php echo $row ['objek']; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Laporan Penduduk Bulan Mei 2023</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="banyak" class=" form-control-label">Lampiran</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="banyak" name="banyak" value="<?php echo $row ['banyak']; ?>"   class="form-control"><small class="form-text text-muted">Contoh : 1 Bundel</small></div>
                                    </div>
                                    <hr>
                                    <h6 class="label">DASAR / LANDASAN :</h6>
                                    <hr> 
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="dasar" class=" form-control-label">Dasar Surat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="dasar" name="dasar" value="<?php echo $row ['dasar']; ?>"  class="form-control"><small class="form-text text-muted">Contoh : Surat Camat Way Sulan Nomor : 123, Tanggal 12 Mei 2023, Perihal Laporan Penduduk Bulan Mei 2023</small></div>
                                    </div>
                                    <hr>
                                    <h6 class="label">NAMA / LEMBAGA YANG DITUJU :</h6>
                                    <hr>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="lbg" class=" form-control-label">Nama / Lembaga yang dituju</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="lbg" name="lbg" value="<?php echo $row ['lbg']; ?>"   class="form-control"><small class="form-text text-muted">Contoh : Camat Way Sulan</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="almt" class=" form-control-label">Alamat yang dituju</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt"  value="<?php echo $row ['almt']; ?>"  class="form-control"></div>
                                    </div>
<hr>
                                    <div class="row form-group">
