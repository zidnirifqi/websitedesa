    ...
    <div id="right-panel" class="right-panel">
          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatAw" data-toggle="modal" data-target="#modalAw" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Ahli Waris</button>
        ...
        <div class="modal" id="modalAw" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        ...
                        <form action="../simpan/s_suketaw.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                             $query = mysqli_query ($con, "SELECT t_suketaw.*, t_penduduk.* FROM t_suketaw, t_penduduk WHERE t_suketaw.kodejenis='JS023' AND t_suketaw.nik=t_penduduk.nik ORDER BY t_suketaw.id DESC ");
                            while ($r = mysqli_fetch_array($query)){
                         ?>
                                        <tr>
                                            <td><?php echo $r['id'];?></td>
                                            ...
                                            <td><a href="../cetak/c_suketaw.php?kode=<?php echo $r['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a><a href="../edit/edit_suketaw.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-edit"></i></a>
                                            <a href="../hapus/h_suketaw.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-trash"></i></a></td>
                                        </tr>
                                       <?php }?>
                                    </tbody>
                                </table>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratpertanahan/suketaw.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN AHLI WARIS</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_suketaw.*, t_penduduk.*  FROM t_suketaw, t_penduduk  WHERE t_suketaw.nik=t_penduduk.nik AND t_suketaw.kode='$_GET[kode]' ");
            $no=1;
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="copy">
                                    <div class="control-group after-add-more">
                                        <table class="">
                                    <?php
                                    $data=mysqli_query($con, "SELECT * FROM t_suketaw WHERE kode='$_GET[kode]' ");
                                    $no=1;
