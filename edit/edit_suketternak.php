          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Pengantar Ternak</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT KETERANGAN PENGANTAR TERNAK</h5>
                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                   <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nmternak" name="nmternak" class="form-control"  placeholder="Ketikan Nama Ternak" ><small class="form-text text-muted">Contoh : Sapi atau Kambing</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jnternak" class=" form-control-label">Jenis Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jnternak" name="jnternak" class="form-control"  placeholder="Ketikan Jenis Ternak" ><small class="form-text text-muted">Contoh : Simental / Etawa</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="ciriternak" class=" form-control-label">Ciri - ciri Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="ciriternak" name="ciriternak" class="form-control"  placeholder="Ketikan Ciri - ciri ternak" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pemilikternak" class=" form-control-label">Pemilik Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="pemilikternak" name="pemilikternak" class="form-control"  placeholder="Ketikan Nama Pemilik Ternak" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="asalternak" class=" form-control-label">Asal Ternak/dari</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="asalternak" name="asalternak" class="form-control"  placeholder="Ketikan dari mana ternak berasal" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tujuanternak" class=" form-control-label">Tujuan Ternak/dikirim ke</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tujuanbrg" name="tujuanternak" class="form-control"  placeholder="Ketikan Tujuan ternak akan di kirim" ></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_suketternak.*, t_penduduk.* FROM t_suketternak, t_penduduk WHERE t_suketternak.kodejenis='JS004' AND t_suketternak.nik=t_penduduk.nik ORDER BY t_suketternak.id ASC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_suketternak.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratumum/suketternak.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN PENGANTAR TERNAK</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php 
                    $data=mysqli_query($con, "SELECT t_suketternak.*, t_penduduk.* from t_suketternak, t_penduduk  where t_suketternak.kode='$_GET[kode]' AND t_suketternak.nik=t_penduduk.nik ");
            $no=1;
            ...
            ?>  
                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                   <div class="row form-group">
                                        <div class="col col-md-3"><label for="nmternak" class=" form-control-label">Nama Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nmternak" name="nmternak" class="form-control"  value="<?php echo $row ['nmternak']; ?>" ><small class="form-text text-muted">Contoh : Sapi atau Kambing</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jnternak" class=" form-control-label">Jenis Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jnternak" name="jnternak" class="form-control"  value="<?php echo $row ['jnternak']; ?>" ><small class="form-text text-muted">Contoh : Simental / Etawa</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="ciriternak" class=" form-control-label">Ciri - ciri Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="ciriternak" name="ciriternak" class="form-control"  value="<?php echo $row ['ciriternak']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pemilikternak" class=" form-control-label">Pemilik Ternak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="pemilikternak" name="pemilikternak" class="form-control"  value="<?php echo $row ['pemilikternak']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="asalternak" class=" form-control-label">Asal Ternak/dari</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="asalternak" name="asalternak" class="form-control"  value="<?php echo $row ['asalternak']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tujuanternak" class=" form-control-label">Tujuan Ternak/dikirim ke</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tujuanbrg" name="tujuanternak" class="form-control"  value="<?php echo $row ['tujuanternak']; ?>" ></div>
                                    </div>
