          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Bepergian</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT KETERANGAN BEPERGIAN</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_suketbepergian.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                   <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tujuan" name="tujuan" class="form-control"  placeholder="Isi dengan Nama Kota tujuan bepergian" ><small class="form-text text-muted">Contoh : Kota Jakarta</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="keg" class=" form-control-label">Dalam rangka / Kegiatan </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="keg" name="keg" class="form-control"  placeholder="Isi dengan Kegiatan yang akan di lakukan" ><small class="form-text text-muted">Contoh : Bekerja</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl" class=" form-control-label">Tanggal Keberangkatan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tgl" name="tgl" class="form-control"  placeholder="Isi dengan tanggal keberangkatan" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="brg" class=" form-control-label">Barang yang dibawa</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="brg" name="brg" class="form-control"  placeholder="Isi dengan Jenis atau Nama Barang yang dibawa" ><small class="form-text text-muted">Contoh : Pakaian ganti</small></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_suketbepergian.*, t_penduduk.* FROM t_suketbepergian, t_penduduk WHERE t_suketbepergian.kodejenis='JS013' AND t_suketbepergian.nik=t_penduduk.nik ORDER BY t_suketbepergian.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_suketbepergian.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratumum/suketbepergian.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN BEPERGIAN</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php 
                    $data=mysqli_query($con, "SELECT t_suketbepergian.*, t_penduduk.* FROM t_suketbepergian, t_penduduk  where t_suketbepergian.kode='$_GET[kode]' AND t_suketbepergian.nik=t_penduduk.nik");
            $no=1;
            ...
            ?>  
                                ...
                                <hr>
                                   <div class="row form-group">
                                        <div class="col col-md-3"><label for="tujuan" class=" form-control-label">Tujuan </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tujuan" name="tujuan" class="form-control"  value="<?php echo $row ['tujuan']; ?>" ><small class="form-text text-muted">Contoh : Kota Jakarta</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="keg" class=" form-control-label">Dalam rangka / Kegiatan </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="keg" name="keg" class="form-control"  value="<?php echo $row ['keg']; ?>" ><small class="form-text text-muted">Contoh : Bekerja</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tgl" class=" form-control-label">Tanggal Keberangkatan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tgl" name="tgl" class="form-control"  value="<?php echo $row ['tgl']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="brg" class=" form-control-label">Barang yang dibawa</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="brg" name="brg" class="form-control"  value="<?php echo $row ['brg']; ?>" ><small class="form-text text-muted">Contoh : Pakaian ganti</small></div>
                                    </div>
