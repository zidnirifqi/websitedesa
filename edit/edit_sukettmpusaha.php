          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Keterangan Tempat Usaha</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT KETERANGAN TEMPAT USAHA</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_sukettmpusaha.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nmusaha" name="nmusaha" class="form-control"  placeholder="Ketikan Nama Usaha yang di Jalankan" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="bdgusaha" class=" form-control-label">Bidang Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="bdgusaha" name="bdgusaha" class="form-control"  placeholder="Ketikan Bidang Usaha yang dijalankan" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="thnbediri" class=" form-control-label">Tahun Berdiri</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="thnberdiri" name="thnberdiri" class="form-control"  placeholder="Ketikan Tahun Berdirinya Usaha yang dijalankan" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pemilikusaha" class=" form-control-label">Pemilik Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="pemilikusaha" name="pemilikusaha" class="form-control"  placeholder="Ketikan Nama Pemilik Usaha yang dijalankan" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jmlpekerja" class=" form-control-label">Jumlah Pekerja</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jmlpekerja" name="jmlpekerja" class="form-control"  placeholder="Ketikan Jumlah Pekerja yang terlibat langsung" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="izinusaha" class=" form-control-label">Izin Usaha yang di Miliki</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="izinusaha" name="izinusaha" class="form-control"  placeholder="Ketikan Nama Surat Izin Usaha yang di miliki" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="alamtusaha" class=" form-control-label">Alamat Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="alamatusaha" name="alamatusaha" class="form-control"  placeholder="Ketikan Alamat/Lokasi Tempat Usaha yang dijalankan" ></div>
                                    </div>
                                <hr>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_sukettmpusaha.*, t_penduduk.* FROM t_sukettmpusaha, t_penduduk WHERE t_sukettmpusaha.kodejenis='JS002' AND t_sukettmpusaha.nik=t_penduduk.nik ORDER BY t_sukettmpusaha.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_sukettmpusaha.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratumum/sukettmpusaha.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT KETERANGAN TEMPAT USAHA</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php 
                    $data=mysqli_query($con, "SELECT * from t_sukettmpusaha  where kode='$_GET[kode]' ");
            $no=1;
            ...
            ?>  
                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nmusaha" class=" form-control-label">Nama Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nmusaha" name="nmusaha" class="form-control"  value="<?php echo $row['nmusaha'];?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="bdgusaha" class=" form-control-label">Bidang Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="bdgusaha" name="bdgusaha" class="form-control"  value="<?php echo $row ['bdgusaha']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="thnbediri" class=" form-control-label">Tahun Berdiri</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="thnberdiri" name="thnberdiri" class="form-control"  value="<?php echo $row ['thnberdiri']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pemilikusaha" class=" form-control-label">Pemilik Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="pemilikusaha" name="pemilikusaha" class="form-control"  value="<?php echo $row ['pemilikusaha']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jmlpekerja" class=" form-control-label">Jumlah Pekerja</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jmlpekerja" name="jmlpekerja" class="form-control"  value="<?php echo $row ['jmlpekerja']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="izinusaha" class=" form-control-label">Izin Usaha yang di Miliki</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="izinusaha" name="izinusaha" class="form-control"  value="<?php echo $row ['izinusaha']; ?>" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="alamtusaha" class=" form-control-label">Alamat Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="alamatusaha" name="alamatusaha" class="form-control"  value="<?php echo $row ['alamatusaha']; ?>"></div>
                                    </div>
                                <hr>
                                <h6>KETERANGAN PEMILIK</h6>
                                <hr>
