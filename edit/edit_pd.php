...
<body>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="#">Tata Usaha</li><li class="active">Surat Perjalanan Dinas</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT PERJALANAN DINAS</h5>
  ...
  <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nama" name="nama" value="<?php echo $rdes['kades']; ?>"  readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nip" class=" form-control-label">NIP</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nip" name="nip" value="<?php echo $rdes['nipkades']; ?>" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pang" class=" form-control-label">Pangkat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="pang" name="pang" placeholder="Pangkat" class="form-control"><small class="form-text text-muted">Opsional *)</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jab" class=" form-control-label">Jabatan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jab" name="jab" Value="Kepala Desa <?php echo $rdes['desa']; ?>" readonly="readonly" class="form-control"></div>
                                    </div>
                                      <?php }} ?>                                                                  <hr>
                        ...
                        <?php 
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><a href="../cetak/c_pd.php?kode=<?php echo $r['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                            <a href="../edit/edit_pd.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../tatausaha/perjalanandinas.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT PERJALANAN DINAS</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_pdinas.*, t_datapdinas.*  FROM t_pdinas, t_datapdinas  WHERE t_pdinas.kode=t_datapdinas.kodepd AND t_pdinas.kode='$_GET[kode]' ");
            $no=1;
                    ...
                    <form action="../update/u_pd.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama" class=" form-control-label">Nama Pejabat / Kepala Desa</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nama" name="nama" value="<?php echo $row['nama']; ?>"  readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nip" class=" form-control-label">NIP</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nip" name="nip" value="<?php echo $row['nip']; ?>" readonly="readonly" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pang" class=" form-control-label">Pangkat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="pang" name="pang" value="<?php echo $row['pang']; ?>" class="form-control"><small class="form-text text-muted">Opsional *)</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jab" class=" form-control-label">Jabatan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jab" name="jab" value="<?php echo $row['jab']; ?>" readonly="readonly" class="form-control"></div>
                                    </div>
                                                                                                       <hr>
                                    <h6 class="label">PEJABAT YG DIBERI TUGAS PERJALANAN DINAS:</h6>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nip1" class=" form-control-label">NIP</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nip1" name="nip1" value="<?php echo $row['nip1']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pang1" class=" form-control-label">Pangkat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="pang1" name="pang1" value="<?php echo $row['pang1']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="jab1" class=" form-control-label">Jabatan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="jab1" name="jab1" value="<?php echo $row['jab1']; ?>" class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tugas" class=" form-control-label">Uraian Tugas</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tugas" name="tugas" value="<?php echo $row['tugas']; ?>"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="tmp" class=" form-control-label">Tempat Tujuan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="tmp" name="tmp" value="<?php echo $row['tmp']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="berangkat" class=" form-control-label">Tanggal Berangkat</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="berangkat" name="berangkat" value="<?php echo $row['berangkat']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="kembali" class=" form-control-label">Tanggal Kembali</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="kembali" name="kembali" value="<?php echo $row['kembali']; ?>" class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="tingkat" id="tingkat" class="form-control" data-toggle="tooltip" data-placement="left" title="Sesuaikan tingkatan biaya sesuai PMK : 07/PMK.05/2008">
                                                <option value="<?php echo $row['tingkat']; ?>" selected="selected"><?php echo $row['tingkat']; ?></option>
                                                <option value="A">Tingkat A</option>
                                                <option value="B">Tingkat B</option>
                                                <option value="C">Tingkat C</option>
                                                <option value="D">Tingkat D</option>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="uh" class=" form-control-label">Uang Harian</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="uh" name="uh" value="<?php echo $row['uh']; ?>" class="form-control"><small class="form-text text-muted">Berupa : Uang Makan, Uang Saku dan Tranfort Lokal</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="trans" class=" form-control-label">Transfort</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="trans" name="trans"value="<?php echo $row['trans']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="inap" class=" form-control-label">Penginapan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="inap" name="inap" value="<?php echo $row['inap']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="rep" class=" form-control-label">Representatif</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="rep" name="rep" value="<?php echo $row['rep']; ?>"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="sewa" class=" form-control-label">Sewa Kendaraan</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="sewa" name="sewa" value="<?php echo $row['sewa']; ?>" class="form-control">
                                    </div>
                                    </div>
