                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="#">Form</a></li>
                            <li class="active">Pelayanan Kependudukan</li>
                        </ol>
                    </div>
                </div>
            </div>
          ...
          <!-- Left Block -->
            <div class="col-md-12">
                <div class="card">
                    ...
                    <button type="button" id="buatSurat" data-toggle="modal" data-target="#modalSurat"  class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Buat Surat Permohonan KTP</button>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">BUAT SURAT PERMOHONAN KTP</h5>
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_sutarpindah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nkk" name="nkk" class="form-control" maxlength="16" readonly="readonly" placeholder="Nomor Kartu Keluarga"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="rt" name="rt"  readonly="readonly" placeholder="Rt. xxx/Rw. xxx" class="form-control">
                                        </div>
                                    </div>
                                     <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="jmlpindah" name="jmlpindah"  placeholder="Isi dengan jumlah keluarga yang ikut pindah" class="form-control"></div>
                                    </div>

                                    <div class="modal-footer">
                                        <div class="col col-md-6"><button type="submit" class="btn btn-primary btn-sm">Cetak</button></div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                       <?php 
                            $query = mysqli_query ($con, "SELECT t_penduduk.*, t_f121.* FROM t_penduduk, t_f121 WHERE t_penduduk.nik=t_f121.nik AND  kodejenis='JS032' ORDER BY t_f121.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="../edit/edit_f121.php?kode=<?php echo "$data[kode]";?>" class="btn"><i class="fa fa-edit"></i></a>
...
<div class="popup-wrapper gulung" id="popup">
    ...
    <div class="popup-container modal-lg"> 
        <a class="popup-close" href="../suratkependudukan/f121.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">EDIT SURAT PERMOHONAN KTP</h5>
 
                            </div>
        <div class="input-group ">
                <div class="col-md-12">
            <?php
            $data=mysqli_query($con, "SELECT t_penduduk.*, t_f121.* FROM t_penduduk, t_f121  WHERE t_penduduk.nik=t_f121.nik AND t_f121.kode='$_GET[kode]' ");
            $no=1;
            ...
            ?>  
                    <form action="../update/u_f121.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nkk" class=" form-control-label">NKK</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="nkk" name="nkk" class="form-control" maxlength="16" value="<?php echo $row ['nkk']; ?>"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="nama" class=" form-control-label">Nama</label></div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="rt" class=" form-control-label">RT/RW.</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="rt" name="rt"  value="<?php echo $row ['rt']; ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="dusun" class=" form-control-label">Dusun</label></div>
