                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="#">Umum</li><li class="active">Surat Keterangan Kematian</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <?php 
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><a href="../cetak/c_suketmati.php?kode=<?php echo $r['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a><a href="../edit/edit_suketmati.php?kode=<?php echo $r['kode'];?>" class="btn"><i class="fa fa-edit"></i></a></td>
                                        </tr>
                                       <?php }?>
                                    </tbody>
                                </table>
