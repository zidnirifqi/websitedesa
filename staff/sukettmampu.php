                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="untuk" name="untuk"  required placeholder="Jelaskan Peruntukan surat" class="form-control"><small class="form-text text-muted">Contoh : Beasiswa</small></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_penduduk.*, t_sukettmampu.* FROM t_penduduk, t_sukettmampu WHERE t_sukettmampu.kodejenis='JS005' AND t_sukettmampu.nik=t_penduduk.nik ORDER BY t_sukettmampu.id DESC ");
                            $no=1;
