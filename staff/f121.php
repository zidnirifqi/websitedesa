                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="#">Kependudukan</li><li class="active">Surat Pengantar Pindah</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <?php
                                ...
                                <form action="../simpan/s_f121.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <hr>
                                <div class="row form-group">
                                        <div class="col col-md-3"><label for="tujuan" class=" form-control-label">Jenis Permohonan</label></div>
                                        <div class="col-12 col-md-9">
                        ...
                        <?php 
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['rt'];?> <?php echo $data['dusun'];?></td>
                                            <td>
