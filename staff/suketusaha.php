                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="#">Umum</li><li class="active">Surat Keterangan Usaha</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body card-block">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="jnusaha" name="jnusaha" placeholder="Isi dengan Jenis atau Bidang Usaha yang dijalani"  class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="mulaiusaha" class=" form-control-label">Berjalan Sejak</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="mulaiusaha" name="mulaiusaha" placeholder="Isi dengan tanggal, bulan atau tahun mulai memiliki usaha tsb."  class="form-control"></div>
                                    </div>
                                                                        <div class="row form-group">
                                        <div class="col col-md-3"><label for="lokusaha" class=" form-control-label">Alamat / Lokasi Usaha</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="lokusaha" name="lokusaha" placeholder="Isi dengan alamat atau lokasi tempat Usaha"  class="form-control"></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT t_suketusaha.*, t_penduduk.* FROM t_suketusaha, t_penduduk WHERE kodejenis='JS001' AND t_suketusaha.nik=t_penduduk.nik ORDER BY t_suketusaha.id DESC ");
                            $no=1;
