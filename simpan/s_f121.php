...
mysqli_query($con, "INSERT INTO t_f121 values('','$kode','$kodejenis','$nmsurat','$nosur','$jp','$nik', '".date('Y-m-d')."','$kades','".$nama_qr.".png')");

echo "<script>alert('Surat Pengantar Pindah berhasil dibuat!'); window.location = '../cetak/c_f121.php?kode=$kode'</script>"; 
}
?>
