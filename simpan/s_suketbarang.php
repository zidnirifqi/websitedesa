...
mysqli_query($con, "INSERT INTO t_suketbarang values('','$kode','$kodejenis','$nmsurat','$nosur','$nmbrg','$jnbrg','$jmlbrg','$pemilikbrg','$asalbrg','$tujuanbrg','$nik', '$nama','".date('Y-m-d')."','$kades','".$nama_qr.".png','')");
