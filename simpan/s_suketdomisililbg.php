...
mysqli_query($con, "INSERT INTO t_suketdomisililbg (kode, kodejenis, nmsurat, no, nama_lbg, bidang_lbg, nama_ketua, sejak, alamat, tanggal, ttd, qrcode) values('$kode','$kodejenis','$nmsurat','$nosur','$nmlbg', '$bdglbg','$nmket','$sejak','$almt','".date('Y-m-d')."','$kades','".$nama_qr.".png')");
