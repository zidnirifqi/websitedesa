...
mysqli_query($con, "INSERT INTO t_suketlain values('','$kode','$kodejenis','$nmsurat','$ns','$nosur','$nik', '$nama','$jk','$tmp_lahir','$tgl_lahir','$agama','$almt','','$rdtengah','','".date('Y-m-d')."','$kades','".$nama_qr.".png')");
