...
mysqli_query($con, "INSERT INTO t_suketpenguburan values('','$kode','$kodejenis','$nmsurat','$nosur','$nik', '$nama','$jk','$tmp_lahir','$tgl_lahir','$agama','$almt','$tgl','$nmmakam','".date('Y-m-d')."','$kades','".$nama_qr.".png','')");
