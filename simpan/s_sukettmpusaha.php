...
mysqli_query($con, "INSERT INTO t_sukettmpusaha values('','$kode','$kodejenis','$nmsurat','$nosur','$nmusaha','$bdgusaha','$thnberdiri','$pemilikusaha','$jmlpekerja','$izinusaha','$alamatusaha','$nik','$nama','".date('Y-m-d')."','$kades','".$nama_qr.".png','')");
