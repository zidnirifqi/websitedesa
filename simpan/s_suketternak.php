...
mysqli_query($con, "INSERT INTO t_suketternak values('','$kode','$kodejenis','$nmsurat','$nosur','$nmternak','$jnternak','$ciriternak','$pemilikternak','$asalternak','$tujuanternak','$nik', '$nama','".date('Y-m-d')."','$kades','".$nama_qr.".png')");
