...
mysqli_query($con, "INSERT INTO t_suketdj values('','$kode','$kodejenis','$nmsurat','$nosur','$nik', '$nama','".date('Y-m-d')."','$kades','".$nama_qr.".png','')");

echo "<script>alert('Surat Keterangan Duda / Janda berhasil dibuat!'); window.location = '../cetak/c_suketdj.php?kode=$kode'</script>"; 
}
?>
