...
$nosur = $kode_klasi.$slash.$no.$slash.$blnr.$slash.$thn;
   ...
   mysqli_query($con, "INSERT INTO t_suketlahir values('','$kode','$kodejenis','$nmsurat','$nosur','$nik2','$nama2','$jk2','$tmp_lahir2','$tgl_lahir2','$agama2', '$almt2', '$anake', '$nik','$nama','$jk','$tmp_lahir','$tgl_lahir','$agama', '$almt', '$nik1','$nama1','$jk1','$tmp_lahir1','$tgl_lahir1','$agama1', '$almt1', '".date('Y-m-d')."','$kades','".$nama_qr.".png','')");
