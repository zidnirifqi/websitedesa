...
mysqli_query($con, "INSERT INTO t_suketrtms values('','$kode','$kodejenis','$nmsurat','$nosur','$nik', '$nama','$jk','$tmp_lahir','$tgl_lahir','$agama','$almt','$niki', '$namai','$jki','$tmp_lahiri','$tgl_lahiri','$agamai','$almti','".date('Y-m-d')."','$kades','".$nama_qr.".png','')");
