...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_sukettmpusaha.*, t_penduduk.* from t_jenissurat, t_datasurat, t_sukettmpusaha, t_penduduk WHERE t_sukettmpusaha.kode='$kodesurat' AND t_sukettmpusaha.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <tr>
    <td>Nama Usaha</td><td>:</td><td><b><?php echo $r['nmusaha'];?></b></td>
  </tr>
    <tr>
    <td>Bidang Usaha</td><td>:</td><td><?php echo $r['bdgusaha'];?></td>
  </tr>
    <tr>
    <td>Tahun Berdiri</td><td>:</td><td><?php echo $r['thnberdiri'];?></td>
  </tr>
    <tr>
    <td>Nama Pemilik Usaha</td><td>:</td><td><?php echo $r['pemilikusaha'];?></td>
  </tr>
    <tr>
    <td>Jumlah Pekerja</td><td>:</td><td><?php echo $r['jmlpekerja'];?></td>
  </tr>
    <tr>
    <td>Izin Usaha</td><td>:</td><td><?php echo $r['izinusaha'];?></td>
  </tr>
    <tr>
    <td>Alamat Tempat Usaha</td><td>:</td><td><?php echo $r['alamatusaha'];?></td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
