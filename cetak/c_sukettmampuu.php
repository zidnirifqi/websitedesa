...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_sukettmampuu.* from t_jenissurat, t_datasurat, t_sukettmampuu WHERE t_sukettmampuu.kode='$kodesurat'");
