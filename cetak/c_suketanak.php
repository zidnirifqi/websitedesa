...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketanak.* from t_jenissurat, t_datasurat, t_suketanak 
WHERE t_suketanak.kode='$kodesurat'");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Nama</td><td>:</td><td><b><?php echo $r['namaanak'];?></b></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Tmp. & Tgl. Lahir </td><td>:</td><td><?php echo $r['tmp_lahiranak'];?>, <?php echo $r['tgl_lahiranak'];?></td>
  </tr>
    <tr>
...
<table align="center" class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td></td><td>Tmp. & Tgl. Lahir </td><td>:</td><td><?php echo $r['tmp_lahirayah'];?>, <?php echo $r['tgl_lahirayah'];?></td>
  </tr>
    <tr>
  ...
  <tr>
    <td></td><td>Tmp. & Tgl. Lahir </td><td>:</td><td><?php echo $r['tmp_lahiribu'];?>, <?php echo $r['tgl_lahiribu'];?></td>
  </tr>
    <tr>
