...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_sukettanah.*, t_penduduk.* from t_jenissurat, t_datasurat, t_sukettanah, t_penduduk WHERE t_sukettanah.kode='$kodesurat' AND t_sukettanah.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>8.</td><td>Alamat</td><td>:</td><td><?php echo $r['rt'];?> <?php echo $r['dusun'];?> Desa <?php echo $r['desa'];?></td>
  </tr>
  <tr>
    ...
    <tr>
    <td colspan="4">Warga tersebut diatas memiliki Tanah yang diperoleh dari <?php echo $r['asaltanah'];?> seluas <?php echo $r['luas'];?> M2 yang terletak di <?php echo $r['letak'];?>, dengan batas - batas sebagai berikut :</td>
  </tr>
    <tr>
    <td>1.</td><td>Barat berbatasan dengan</td><td>:</td><td><?php echo $r['barat'];?></td>
  </tr>
      <tr>
    <td>2.</td><td>Utara berbatasan dengan</td><td>:</td><td><?php echo $r['utara'];?></td>
  </tr>
      <tr>
    <td>3.</td><td>Timur berbatasan dengan</td><td>:</td><td><?php echo $r['timur'];?></td>
  </tr>
      <tr>
    <td>4.</td><td>Selatan berbatasan dengan</td><td>:</td><td><?php echo $r['selatan'];?></td>
  </tr>
    <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
