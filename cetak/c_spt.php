...
<table align="center" class="table-print" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Pangkat</td><td>:</td><td><?php echo $r['pang'];?></td>
  </tr>
    <tr>
  ...
  <tr>
    <td></td><td>NIP</td><td>:</td><td><?php echo $r['nip1'];?></td>
  </tr>
    <tr>
    <td></td><td>Pangkat</td><td>:</td><td><?php echo $r['pang1'];?></td>
  </tr>
    <tr>
    <td></td><td>Jabatan</td><td>:</td><td><?php echo $r['jab1'];?></td>
  </tr>
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td colspan="3">Untuk <?php echo $r['tugas'];?> di <?php echo $r['tmp'];?> pada tanggal <?php echo $r['berangkat'];?> sampai dengan selesai.</td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
...
<table width="400" align="right" border="0" cellspacing="1" cellpadding="4" class="table-print">
    ...
    <td>&nbsp;</td>
      ...
      <tr>
    <td align="center" class="pull pull-right"><b><u><?php echo $r['nama'];?></u></b></td>
  </tr>
        <tr>
