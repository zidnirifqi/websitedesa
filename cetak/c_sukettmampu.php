...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_sukettmampu.*, t_penduduk.* from t_jenissurat, t_datasurat, t_sukettmampu, t_penduduk WHERE t_sukettmampu.kode='$kodesurat' AND t_sukettmampu.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <td colspan="3" align="center"><br><b><?php echo strtoupper($r['untuk']);?></b></td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
