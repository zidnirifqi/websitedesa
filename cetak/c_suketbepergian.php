...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketbepergian.*, t_penduduk.* from t_jenissurat, t_datasurat, t_suketbepergian, t_penduduk WHERE t_suketbepergian.kode='$kodesurat' AND t_suketbepergian.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td colspan="3">&nbsp;</td>
      ...
      <tr>
    <td>Tujuan</td><td>:</td><td><?php echo $r['tujuan'];?></td>
  </tr>
    <tr>
    <td>Dalam Rangka / Kegiatan</td><td>:</td><td><?php echo $r['keg'];?></td>
  </tr>
    <tr>
    <td>Tanggal Keberangkatan</td><td>:</td><td><?php echo $r['tgl'];?></td>
  </tr>
    <tr>
    <td>Barang yang dibawa</td><td>:</td><td><?php echo $r['brg'];?></td>
  </tr>
