...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketpnikah.* from t_jenissurat, t_datasurat, t_suketpnikah WHERE t_suketpnikah.kode='$kodesurat'");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Pekerjaan</td><td>:</td><td><?php echo $r['pkjn'];?></td>
  </tr>
     <tr>
    <td></td><td valign="top">Alamat</td><td valign="top">:</td><td valign="top"><?php echo $r['alamat'];?> Desa <?php echo $r['desa'];?><br>Kec. <?php echo $r['kec'];?> Kab. <?php echo $r['kab'];?> Prov. <?php echo $r['prov'];?></td>
  </tr>
<tr>
    <td colspan="4">&nbsp;</td>
  </tr>
    ...
    <tr>
    <td colspan="4">Warga tersebut diatas adalah bernar Warga Desa <?php echo $rd['desa'];?>  dan yang bersangkutan <b>Pernah Menikah</b> secara <?php echo $r['secara'];?> pada <?php echo $r['tgl_nikah'];?> dengan :</td>
  </tr>
    <tr>
    <td></td><td>Nama </td><td>:</td><td><?php echo $r['nama1'];?></td>
  </tr>
  <tr>
    <td></td><td>NIK</td><td>:</td><td><?php echo $r['nik1'];?></td>
  </tr>
    <tr>
    <td></td><td>Tmp.&Tgl. Lahir</td><td>:</td><td><?php echo $r['tmp_lahir1'];?>, &nbsp; <?php echo $r['tgl_lahir1'];?></td>
  </tr>
    <tr>
    <td></td><td>Kewarganegaraan</td><td>:</td><td><?php echo $r['kwng1'];?></td>
  </tr>
    <tr>
    <td></td><td>Agama</td><td>:</td><td><?php echo $r['agama1'];?></td>
  </tr>
    <tr>
    <td></td><td>Pekerjaan</td><td>:</td><td><?php echo $r['pkjn1'];?></td>
  </tr>
   <tr>
    <td></td><td valign="top">Alamat</td><td valign="top">:</td><td valign="top"><?php echo $r['alamat1'];?> Desa <?php echo $r['desa1'];?><br>Kec. <?php echo $r['kec1'];?> Kab. <?php echo $r['kab1'];?> Prov. <?php echo $r['prov1'];?></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
