...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketlahir.* from t_jenissurat, t_datasurat, t_suketlahir 
WHERE t_suketlahir.kode='$kodesurat'");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Anak ke</td><td>:</td><td><?php echo $r['anake'];?></td>
  </tr>
    <tr>
