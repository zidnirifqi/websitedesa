...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketdj.*, t_penduduk.* from t_jenissurat, t_datasurat, t_suketdj, t_penduduk WHERE t_suketdj.kode='$kodesurat' AND t_suketdj.nik=t_penduduk.nik");
