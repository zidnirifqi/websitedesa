...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_pemberitahuan.* from t_jenissurat, t_datasurat, t_pemberitahuan WHERE t_pemberitahuan.kode='$kodesurat'");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
        <td></td><td></td><td><?php echo $r['tujuan'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td></td><td></td><td colspan="3" align="justify"><?php echo $r['detail'];?>. </td>
  </tr>
    <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
