...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_ahliwaris.*, t_suketaw.*, t_penduduk.* from t_jenissurat, t_datasurat, t_ahliwaris, t_suketaw, t_penduduk
WHERE t_suketaw.kode='$kodesurat' AND t_suketaw.nik=t_penduduk.nik");
