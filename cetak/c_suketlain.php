...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketlain.*, t_penduduk.* from t_jenissurat, t_datasurat, t_suketlain, t_penduduk WHERE t_suketlain.kode='$kodesurat' AND t_suketlain.nik=t_penduduk.nik");
