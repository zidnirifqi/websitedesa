...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketpenguburan.*, t_penduduk.* from t_jenissurat, t_datasurat, t_suketpenguburan, t_penduduk WHERE t_suketpenguburan.kode='$kodesurat' AND t_suketpenguburan.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Nama tersebut diatas adalah Warga Desa <?php echo $rd['desa'];?> yang telah meninggal dunia dan di <b>Kuburkan di Pemakaman <?php echo $r['nmmakam']; ?> Desa <?php echo $rd['desa'];?>  pada tanggal <?php echo $r['tglpenguburan']; ?></b>.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
