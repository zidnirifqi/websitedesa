...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_jawaban.* from t_jenissurat, t_datasurat, t_jawaban WHERE t_jawaban.kode='$kodesurat'");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Lampiran </td><td>:</td><td><?php echo $r['lampiran'];?></td><td></td>
  </tr>
  <tr>
    <td valign="top">Perihal</td><td valign="top">:</td><td valign="top"><b><?php echo $r['perihal'];?></b></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td></td><td></td><td colspan="3" align="justify">Menjawab surat <?php echo $r['dasar'];?>, berikut ini Kami sampaikan bahwa <?php echo $r['jawaban'];?></td>
  </tr>
    <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
