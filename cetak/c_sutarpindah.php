...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_sutarpindah.*, t_penduduk.* from t_jenissurat, t_datasurat, t_sutarpindah, t_penduduk WHERE t_sutarpindah.kode='$kodesurat' AND t_sutarpindah.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>Tujuan Pindah</td><td>:</td><td><?php echo $r['tujuan'];?></td>
  </tr>
      <tr>
    <td>Jumlah Keluarga yang Ikut</td><td>:</td><td><?php echo $r['jmlpindah'];?></td>
  </tr>
