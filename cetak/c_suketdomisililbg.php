...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketdomisililbg.* from t_jenissurat, t_datasurat, t_suketdomisililbg WHERE t_suketdomisililbg.kode='$kodesurat'");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Nama Lembaga</td><td>:</td><td><?php echo $r['nama_lbg'];?></td>
  </tr>
  <tr>
    <td>Bidang</td><td>:</td><td><?php echo $r['bidang_lbg'];?></td>
  </tr>
    <tr>
    <td>Nama Pimpinan/Ketua</td><td>:</td><td><?php echo $r['nama_ketua'];?></td>
  </tr>
    <tr>
    <td>Berdiri Sejak</td><td>:</td><td><?php echo $r['sejak'];?></td>
  </tr>
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $r['alamat'];?></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="3">Lembaga/Organisai tersebut adalah benar telah berdiri dan berada sesuai alamat tersebut diatas, sejak <?php echo $r['sejak']; ?> dan masih aktif sampai dengan sekarang.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
