...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketortu.* from t_jenissurat, t_datasurat, t_suketortu 
WHERE t_suketortu.kode='$kodesurat'");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td></td><td width="25%">Nama</td><td>:</td><td><?php echo $r['namaibu'];?></td>
  </tr>
  <tr>
