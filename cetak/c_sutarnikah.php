...
<!--  PEMERIKSAAN NIKHA -->
    <div class="modal" id="modalNikah" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="hubwali" id="hubwali" class="form-control" onchange="if(this.selectedIndex==0){{document.getElementById('nwali').style.display = 'none' }{document.getElementById('awali').style.display = 'none' }}  else if (this.selectedIndex==1){{document.getElementById('nwali').style.display = 'inline' } {document.getElementById('swali').style.display = 'none' }} else if (this.selectedIndex==2){{document.getElementById('nwali').style.display = 'inline'}};">
    ...
    <!-- END FORMULIR PEMERIKSAAN NIKHA -->
...
<div class="popup-wrapper" id="popup">
    ...
    <div class="popup-container"> 
        <a class="popup-close" href="../suratpernikahan/sutarnikah.php"><span aria-hidden="true">&times;</span></a>                              
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">CETAK N1 - N6</h5>
            ...
            ?>  
                        <form action="../update/u_sutarnikah.php"  method="post" onsubmit="return validasi_input(this)"  enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <a href="c_n1.php?kode=<?php echo $row['kode'];?>" type="button" class="btn btn-primary" target='_BLANK'><i class="fa fa-print"></i>&nbsp;N1</a>
                                        <a href="c_n2.php?kode=<?php echo $row['kode'];?>" type="button" class="btn btn-secondary" target='_BLANK'><i class="fa fa-print"></i>&nbsp;N2</a>
                                        <a href="c_n3.php?kode=<?php echo $row['kode'];?>" type="button" class="btn btn-success" target='_BLANK'><i class="fa fa-print"></i>&nbsp;N3</a>

                                        <a href="c_n4.php?kode=<?php echo $row['kode'];?>" type="button" class="btn btn-warning" target='_BLANK'><i class="fa fa-print"></i>&nbsp;N4 </a>
                                        <a href="c_n5.php?kode=<?php echo $row['kode'];?>" type="button" class="btn btn-danger" target='_BLANK'><i class="fa fa-print"></i>&nbsp;N5</a>
                                        <a href="../suratpernikahan/n6.php" type="button" class="btn btn-info" target='_BLANK'><i class="fa fa-print"></i>&nbsp;N6</a>
                                        <!--
