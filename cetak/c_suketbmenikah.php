...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketbnikah.*, t_penduduk.* from t_jenissurat, t_datasurat, t_suketbnikah, t_penduduk WHERE t_suketbnikah.kode='$kodesurat' AND t_suketbnikah.nik=t_penduduk.nik");
