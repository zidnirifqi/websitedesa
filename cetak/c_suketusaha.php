...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketusaha.*, t_penduduk.* from t_jenissurat, t_datasurat, t_suketusaha, t_penduduk WHERE t_suketusaha.kode='$kodesurat' AND t_suketusaha.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>Jenis/Bidang Usaha</td><td>:</td><td><?php echo $r['jnusaha'];?></td>
  </tr>
      <tr>
    <td>Berjalan Sejak</td><td>:</td><td><?php echo $r['mulaiusaha'];?></td>
  </tr>
      <tr>
    <td>Alamat / Lokasi Usaha</td><td>:</td><td><?php echo $r['lokusaha'];?></td>
  </tr>
