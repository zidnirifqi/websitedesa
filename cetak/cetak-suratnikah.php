...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suratnikah.* from t_jenissurat, t_datasurat, t_suratnikah 
WHERE t_suratnikah.kode='$kodesurat'");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td><b>I.</b></td><td colspan="3"><b>IDENTITAS SUAMI :</b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Jenis Kelamin</td><td>:</td><td><?php echo $r['jk'];?></td>
  </tr>
    <tr>
  ...
  <tr>
    <td><b>II.</b></td><td colspan="3"><b>IDENTITAS ISTRI :</b></td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Jenis Kelamin</td><td>:</td><td><?php echo $r['jkistri'];?></td>
  </tr>
    <tr>
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td colspan="3"><?php echo $r['redaksi_tengah'];?></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="3"><?php echo $r['redaksi_akhir'];?></td>
  </tr>
