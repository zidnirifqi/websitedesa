...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketbarang.*, t_penduduk.* from t_jenissurat, t_datasurat, t_suketbarang, t_penduduk WHERE t_suketbarang.kode='$kodesurat' AND t_suketbarang.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <tr>
    <td>Nama Barang</td><td>:</td><td><b><?php echo $r['nmbrg'];?></b></td>
  </tr>
    <tr>
    <td>Jenis/Model Barang</td><td>:</td><td><?php echo $r['jnbrg'];?></td>
  </tr>
    <tr>
    <td>Jumlah/Ukuran/Berat</td><td>:</td><td><?php echo $r['jmlbrg'];?></td>
  </tr>
    <tr>
    <td>Nama Pemilik Barang</td><td>:</td><td><?php echo $r['pemilikbrg'];?></td>
  </tr>
    <tr>
    <td>Asal Barang/dari</td><td>:</td><td><?php echo $r['asalbrg'];?></td>
  </tr>
    <tr>
    <td>Tujuan Barang/dikirim ke</td><td>:</td><td><?php echo $r['tujuanbrg'];?></td>
  </tr>
