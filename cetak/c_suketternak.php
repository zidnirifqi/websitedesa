...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketternak.*, t_penduduk.* from t_jenissurat, t_datasurat, t_suketternak, t_penduduk WHERE t_suketternak.kode='$kodesurat' AND t_suketternak.nik=t_penduduk.nik");
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <tr>
    <td>Nama Ternak</td><td>:</td><td><b><?php echo $r['nmternak'];?></b></td>
  </tr>
    <tr>
    <td>Jenis Ternak</td><td>:</td><td><?php echo $r['jnternak'];?></td>
  </tr>
    <tr>
    <td>Ciri - ciri Ternak</td><td>:</td><td><?php echo $r['ciriternak'];?></td>
  </tr>
    <tr>
    <td>Nama Pemilik Ternak</td><td>:</td><td><?php echo $r['pemilikternak'];?></td>
  </tr>
    <tr>
    <td>Asal Ternak/dari</td><td>:</td><td><?php echo $r['asalternak'];?></td>
  </tr>
    <tr>
    <td>Tujuan Ternak/dikirim ke</td><td>:</td><td><?php echo $r['tujuanternak'];?></td>
  </tr>
