...
$query = mysqli_query ($con, "SELECT t_jenissurat.*, t_datasurat.*, t_suketmenikah.* from t_jenissurat, t_datasurat, t_suketmenikah WHERE t_suketmenikah.kode='$kodesurat'");
...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Nama </td><td>:</td><td><?php echo $r['namaistri'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td></td><td valign="top">Alamat</td><td valign="top">:</td><td valign="top"><?php echo $r['alamatistri'];?> Desa <?php echo $r['desai'];?><br>Kec. <?php echo $r['keci'];?> Kab. <?php echo $r['kabi'];?> Prov. <?php echo $r['provi'];?></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
    ...
    <tr>
    <td></td><td>Tanggal Menikah</td><td>:</td><td><?php echo $r['tgl_nikah'];?></td>
  </tr>
    <tr>
    <td></td><td>Menikah Secara </td><td>:</td><td><?php echo $r['secara'];?></td>
  </tr>
    <tr>
    <td></td><td>Mahar / Maskawin</td><td>:</td><td><?php echo $r['mahar'];?></td>
  </tr>
    <tr>
    <td></td><td>Nama Saksi 1</td><td>:</td><td><?php echo $r['saksi1'];?></td>
  </tr>
    <tr>
    <td></td><td>Nama Saksi 2</td><td>:</td><td><?php echo $r['saksi2'];?></td>
  </tr>
    <tr>
    <td></td><td>Alasan Surat</td><td>:</td><td><?php echo $r['alasan'];?></td>
  </tr>
